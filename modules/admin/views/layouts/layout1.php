...
<head>
    ...
    <![endif]-->
    <title><?php  echo $this->params['menu']; ?></title>
    <meta name="keywords" content="商城模板">
    <meta name="description" content="商城模板">
</head>
<body>
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php  echo yii\helpers\Url::to(['index/index']); ?>">管理后台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href=""></a>
                ...
                <ul class="cl">
                    ...
                    <li class="dropDown dropDown_hover">
                        ...
                        <ul class="dropDown-menu menu radius box-shadow">
                            ...
                            <li><a href="#">切换账户</a></li>
                            <li><a href="<?php echo yii\helpers\Url::to(['user/logout']);?>">退出</a></li>
                        </ul>
                    </li>
        ...
        <dl id="menu-admin">
            ...
            <dd>
                <ul>
                    ...
                    <li><a data-href="<?php echo yii\helpers\Url::to(['user/list']); ?>" data-title="管理员列表" href="javascript:void(0)">管理员列表</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-tongji">
...
<script type="text/javascript" src="/assets/admin/static/h-ui.admin/js/H-ui.admin.js"></script> <!--/_footer 作为公共模版分离出去-->

<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="/assets/admin/lib/jquery.contextmenu/jquery.contextmenu.r2.js"></script>
